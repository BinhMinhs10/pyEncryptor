...
class Encryptor:
    ...
    def __init__(self, file_path):
        ...
        # Creating .pvx file
        self.file_pyx_name = self.file_base_name + '.py'
    ...
    def encrypt(self):
        ...
        print("Now you can directly use import {} to use your file and"
...
if __name__ == "__main__":
    ...
    PARSER.add_argument('-f', '--file', type=str, action='store', help='Enter the file_path(if '
                                                                       'file is in other '
